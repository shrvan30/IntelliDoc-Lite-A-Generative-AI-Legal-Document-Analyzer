...
import { useDocuments } from '../../context/DocumentContext.jsx'; // Assuming .jsx extension
    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <p className="text-xs text-gray-400 mt-1">
          Supports: NDA, MSA, Contracts, Deeds, etc. (.pdf, .docx)
        </p>
        ...
        <input
          ...
          // The accept prop still looks for the file types
          accept=".pdf,.docx,.txt" 
